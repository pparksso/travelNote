...
- 하트 기능 구현해야됨.. 로그인 하기 전 메인페이지에는 하트 x
- 메인페이지 하트 로딩 시 userInfo에 heart배열을 추가해서 그 정보를 토대로 하트 모양이 바뀌게 .. (heart배열을 mapping해서 list의 no와 대조)
- 메인 페이지에서 하트 클릭 가능(팝업창 안의 수와 모양도 변경되어야함)
