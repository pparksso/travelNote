...
router.get("/", async (req, res) => {
  try {
    ...
    res.render("index", { startPage: startPage, minPage: minPage, totalPage: totalPage, page: page, userInfo: req.user, title: "Welcome back!", list: contents, comments: comments });
  } catch (err) {
    res.redirect("500");
  }
});
